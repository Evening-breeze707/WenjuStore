    ...
    <el-tabs tab-position="left" :style='{"width":"100%","flexWrap":"wrap","background":"none","justifyContent":"center","display":"flex"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="180px">
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonghu'" label="用户账号" prop="yonghuzhanghao">
          ...
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonghu'" label="用户姓名" prop="yonghuxingming">
          ...
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonghu'" label="年龄" prop="nianling">
          ...
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonghu'" label="手机号" prop="shoujihao">
          ...
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonghu'" label="头像">
            <el-upload
              ...
              <img :style='{"border":"1px solid #e5d9c6","cursor":"pointer","color":"#333","borderRadius":"6px","textAlign":"center","width":"100px","fontSize":"32px","lineHeight":"100px","height":"100px"}' v-if="sessionForm.touxiang" :src="getDisplayAvatar(sessionForm.touxiang)" class="avatar">
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
          <el-form-item class="balance" :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonghu'" label="余额">
            <div :style='{"flexWrap":"wrap","display":"flex"}'>
				<el-input v-model="sessionForm.money" placeholder="余额" readonly></el-input>
				<div @click="dialogFormVisibleMoney = true" :style='{"border":"1px solid #e5d9c6","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 5px","color":"#b68742","display":"inline-block","outline":"none","borderRadius":"4px","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}'>点我充值</div>
			</div>
		  </el-form-item>
...
<script>
  ...
  export default {
    ...
    //方法集合
    methods: {
      getDisplayAvatar(rawPath) {
        if (!rawPath) return '';
        const purePath = String(rawPath).split('?')[0];
        if (purePath.startsWith('http://') || purePath.startsWith('https://')) {
          return purePath;
        }
        return this.baseUrl + purePath;
      },
      init() {
        if ('yonghu' == this.userTableName) {
